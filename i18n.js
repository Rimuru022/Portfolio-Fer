...
const i18n = {
    en: {
        ...
        'hero.line1': 'I build systems that deliver.', 'hero.line2': 'Results you can measure.',
        'hero.bio': "I build systems that deliver measurable results. At Castrol (BP), my ETL automation slashed reporting time by 80% — freeing dozens of hours every week for the commercial team. At Huawei Cloud, I designed a Text-to-SQL assistant with Zero Trust architecture that achieved 0% SQL injection rate and was prototyped in just 3 days. Every project I touch gets faster, safer, or cheaper — ideally all three. Computer Systems Engineering student at Universidad Iberoamericana, graduating May 2027.",
        ...
        // Services
        'services.tag': 'What I Do',         'services.heading': 'Systems that deliver measurable outcomes',
        ...
        'work.pro.tag': 'Professional Work', 'work.pro.heading': "Results I've delivered",
        ...
        'process.1.desc': 'I analyze your current workflow, identify bottlenecks, and define what success looks like with clear metrics — so we know exactly what we\'re aiming for.',
        ...
        'process.4.desc': 'Smooth handoff with complete documentation. Post-launch, I monitor the metrics we defined in Discovery to confirm the system is delivering as promised.',
    ...
    es: {
        ...
        'hero.line1': 'Construyo sistemas que entregan.',
        'hero.line2': 'Resultados que puedes medir.',
        'hero.bio': "Construyo sistemas que entregan resultados medibles. En Castrol (BP), mi automatización ETL redujo el tiempo de reportes en 80% — liberando decenas de horas cada semana para el equipo comercial. En Huawei Cloud, diseñé un asistente Text-to-SQL con arquitectura Zero Trust que logró 0% de inyección SQL y fue prototipado en solo 3 días. Cada proyecto que toco se vuelve más rápido, más seguro o más económico — idealmente los tres. Estudiante de Ingeniería en Sistemas Computacionales en la Universidad Iberoamericana, graduación mayo 2027.",
        ...
        // Services
        'services.tag': 'Qué Hago',         'services.heading': 'Sistemas que entregan resultados medibles',
        ...
        // Professional Work cards
        'work.pro.tag': 'Trabajo Profesional',         'work.pro.heading': 'Resultados que he entregado',
        ...
        'work.castrol.desc': 'Construí un pipeline ETL que redujo el tiempo de reportes SAP ERP en 80% — de días a minutos. Habilité forecasting mensual de ventas con +/- 15% de precisión, previniendo quiebres de stock en una cadena Fortune 500.',
        ...
        'work.huawei.desc': 'Diseñé un asistente Text-to-SQL con IA protegido por arquitectura Zero Trust. Logré 0% de inyección SQL y entregué un prototipo funcional en solo 3 días.',
        ...
        'process.1.desc': 'Analizo tu flujo actual, identifico cuellos de botella y defino el éxito con métricas claras — para que sepamos exactamente a qué apuntamos.',
        ...
        'process.4.desc': 'Entrega fluida con documentación completa. Post-lanzamiento, monitoreo las métricas que definimos en Descubrimiento para confirmar que el sistema entrega lo prometido.',
